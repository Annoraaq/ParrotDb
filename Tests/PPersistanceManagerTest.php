...
require_once dirname(__DIR__) . "/testclasses/Author.php";
require_once dirname(__DIR__) . "/testclasses/TestRec.php";
require_once dirname(__DIR__) . "/testclasses/Publication.php";
require_once dirname(__DIR__) . "/testclasses/PrivateConstructor.php";
require_once dirname(__DIR__) . "/testclasses/StaticStub.php";

/**
 * Generated by PHPUnit_SkeletonGenerator on 2015-08-18 at 17:07:28.
 */
class PPersistanceManagerTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testTransaction()
    {
        $author = $this->createTestAuthor();
        $this->pm->persist($author);
        $this->assertFalse($this->session->getDatabase()->isPersisted(new PObjectId(0)));
